...
RUN Rscript -e 'if (!require("pacman")) install.packages("pacman"); pacman::p_load(moments,operators,topmodel,DEoptim,XML,data.table,RSQLite,argparse,stringi); system("svn checkout svn://scm.r-forge.r-project.org/svnroot/ecohydrology/"); install.packages(c("ecohydrology/pkg/EcoHydRology/","ecohydrology/pkg/SWATmodel/"),repos = NULL)' 
WORKDIR /mintswat
